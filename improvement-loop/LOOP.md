...
next_focus: "Fill the Repo Readiness Experiment Proof Attachment for the highest-scoring dashboard seed row during the next real blank-profile or repo-readiness run."
tags: [improvement-loop, hermes-agent, public-feedback]
---

# X Feedback Feature Factory Loop

## Purpose
Build a repeatable, visible workflow where public X feedback becomes scoped Hermes Agent improvements and artifacts.
...
1. Add an impact/effort/public-proof scoring table. ✅ Done via [[../Prototypes/X Feedback Feature Factory/Feature-Intake Scoring Template|Feature-Intake Scoring Template]].
...
7. Revisit whether the skill draft should be promoted after one live use.

## Latest useful change
- 2026-05-24: Created the prototype board and flywheel infographic.
- 2026-05-24: Added [[../Prototypes/X Feedback Feature Factory/Feature-Intake Scoring Template|Feature-Intake Scoring Template]] so the next feedback-derived feature can be scored consistently before any build work.
- 2026-06-02: Added [[../Prototypes/X Feedback Feature Factory/Blank-Profile Experiment Template|Blank-Profile Experiment Template]] with sandbox commands, scoring, experiment checklist, and proof-post format.
...
- 2026-06-04: Added [[../Prototypes/X Feedback Feature Factory/Weekly Feedback Dashboard Query|Weekly Feedback Dashboard Query]] so recent X feedback can be triaged into scored candidates, blank-profile tests, shipped proof, and proof-post gaps.
