...
next_focus: "Use scoring, blank-profile, and proof-post templates on one real X feedback item end to end."
...
1. Add an impact/effort/public-proof scoring table.
...
4. Revisit whether the skill draft should be promoted after one live use.
